...
public class ProfileViewVO {
	...
	public ProfileViewVO(int num, String nickname, String email, int age, String mTongue, String interest, int gender,
			String nationality, String selfIntro, int openRange, int fileFlag, String lastVisitDate, String lastProfileUpdate,
			String fileURL) {
		super();
		this.num = num;
	...
	public String toString() {
		return "ProfileViewVO [num=" + num + ", nickname=" + nickname + ", email=" + email + ", age=" + age
				...
				+ nationality + ", selfIntro=" + selfIntro + ", fileFlag=" + fileFlag + ", lastVisitDate="
				+ lastVisitDate + ", lastProfileUpdate=" + lastProfileUpdate + ", fileURL=" + fileURL + "]";
	}
